...
* As a result, the FDA is now allowing 23andMe to market tests that assess genetic risks for breast, ovarian and prostate cancer as well at least 10 additional diseases or conditions. 
...
|               |               
| ------------- | ------------- |
| git add   - .adds all new files    | git commit - commits changes |
